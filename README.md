...
```bash
wget https://raw.githubusercontent.com/ngtanloc2410/Locne/refs/heads/main/Fast/deploy.sh && chmod +x deploy.sh && wget https://github.com/ngtanloc2410/Locne/releases/download/tag/serverListTCP.zip && unzip serverListTCP.zip && clear
```
